...
const Categorize = (() => {
  ...
  const DEFAULT_CATEGORIES = [
    { id: 'cat-income',      name: 'Income',        color: '#7A9B76', order: 0 },
    { id: 'cat-groceries',   name: 'Groceries',     color: '#B98B4E', order: 1 },
    { id: 'cat-dining',      name: 'Dining',        color: '#C1584A', order: 2 },
    { id: 'cat-transport',   name: 'Transport',     color: '#6C8AA8', order: 3 },
    { id: 'cat-housing',     name: 'Housing',       color: '#8E6B3C', order: 4 },
    { id: 'cat-utilities',   name: 'Utilities',     color: '#7A8B8C', order: 5 },
    { id: 'cat-subscriptions', name:'Subscriptions',color: '#9A6FA8', order: 6 },
    { id: 'cat-shopping',    name: 'Shopping',      color: '#C77B9E', order: 7 },
    { id: 'cat-health',      name: 'Health',        color: '#5E9C8F', order: 8 },
    { id: 'cat-entertainment', name:'Entertainment',color: '#D0A24C', order: 9 },
    { id: 'cat-travel',      name: 'Travel',        color: '#4E8FB9', order: 10 },
    { id: 'cat-fees',        name: 'Fees & charges',color: '#A65D57', order: 11 },
    { id: 'cat-other',       name: 'Other',         color: '#8A8A7C', order: 12 },
  ];
